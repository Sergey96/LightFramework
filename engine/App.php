...
use engine\core\exceptions\URLNotFoundException;
...
class App
{
    ...
    {
        session_start();
        set_error_handler("\\engine\\App::LightErrorHandler");
        error_reporting(0);
    ...
    private function isAjaxMode(): bool
    {
    ...
    private function detectLocation()
    {
        ...
        self::$basePath = $this->levelUpDir($this->levelUpDir(self::$config['home']));
    }
     ...
     * - нужно когда путь приходит в виде строки
     */
